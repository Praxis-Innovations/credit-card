...
export function AppResults({
  ...
  if (recommendations.length === 0) {
    return (
      <div className="flex min-h-[180px] flex-col items-center justify-center rounded-2xl border border-dashed border-border bg-card/40 px-6 py-10 text-center">
  ...
  return (
    <ol className="space-y-3" aria-label="Ranked card recommendations">
            ...
            <div className="flex items-start justify-between gap-4">
              <div className="min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  >
                    {isTop ? <Trophy className="h-3.5 w-3.5" /> : rec.rank}
                  </span>
              ...
              <div className="shrink-0 text-right">
                ...
                >
                  est. back
                  {amountCad ? ` · ${formatCentsPerDollar(rec.centsPerDollar)}` : ""}
                </p>
              </div>
            </div>
          </li>
